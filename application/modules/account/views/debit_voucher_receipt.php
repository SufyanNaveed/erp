                        ...
                        <div class="panel-body">
                            <div bgcolor='#e4e4e4' text='#ff6633' link='#666666' vlink='#666666' alink='#ff6633' class="phdiv" >
                                <table border="1" width="100%" style="border-spacing: 30px;">
                                    <tr>
                                        <td >
                                            ...
                                            <table border="0" width="100%" >
                                                ...
                                                <tr>
                                                    <td colspan="2" align="center" style="border:1px solid black;border-left:1px solid black;border-right:1px solid black;"><b>Debit Voucher</b></td>
                                                </tr>
                                    ...
                                    <tr>
                                    <td class="text-left"></td><td class="text-left"><?php echo 'Amount'; ?> : <span style="border-bottom: 1px solid black;"><?php echo  html_escape($voucher_info[0]['Debit']);?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
                                    </tr>
