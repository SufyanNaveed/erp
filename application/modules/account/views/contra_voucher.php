...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                         ...
                         <?php echo  form_open_multipart('account/account/bdtask_create_contra_voucher','id="validate"') ?>
   ...
   <option value="<?php echo $acc1->HeadCode;?>"><?php echo $acc1->HeadName;?></option>
         <?php }?>
                                       ...
                                       <td>
                                                <button  class="btn delete_btn" type="button"  onclick="deleteRowContravoucher(this)"><i class="fal fa-trash-alt"></i></button>
                                            </td>
                                    </tr>                              
                             ...
                             <tfoot>
                                    <tr>
                                      <td >
                                        ...
                                        <td><a id="add_more" class="btn edit_btn" name="add_more"  onClick="addaccountContravoucher('debitvoucher')"><i class="fal fa-plus"></i></a>
