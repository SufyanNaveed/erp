                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <table class="table table-hover" id="normalinvoice">
                                ...
                                <tfoot>
                                    ...
                                    <td><a  id="add_invoice_item" class="btn edit_btn" name="add-invoice-item"  onClick="addInputField('addinvoiceItem');"  tabindex="11"><i class="fa fa-plus"></i></a></td>
                                </tr>
                                <tr>
                        ...
                        <div>
                         ...
                         <div class="row" id="quotation_service">
                           ...
                           <div class="table-responsive margin-top10">
                            <table class="table table-hover" id="serviceInvoice">
                                <thead>
                                    <tr>
...
<input type="hidden" id="all_service_discount_1" class="totalServiceDicount" name="sdiscount_amount[]">
                                ...
                                <td><button type="button" id="add_service_item" class="btn edit_btn" name="add-invoice-item"  onClick="addService('addservicedata');"><i class="fa fa-plus"></i></button></td>
                                </tr>
                                <tr>
