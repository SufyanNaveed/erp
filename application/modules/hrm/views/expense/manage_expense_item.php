                   ...
                   <tbody>
                    ...
                    if ($expense_item_list) {
                        ...
                        <tr>
                            ...
                            <td> <a href="<?php echo base_url("hrm/expense/delete_expense_item/".$expense['id']) ?>" class="btn delete_btn" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fal fa-trash-alt"></i></a> </td>
                        </tr>
                          <?php $sl++;}}else{?>
