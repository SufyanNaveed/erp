                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a href='javascript:;' onclick='generate_barcode();' class="btn details_btn" data-toggle="tooltip" data-placement="left" title="" data-original-title="Generate Barcode">
                                <i class="fal fa-barcode" aria-hidden="true"></i></a>
                            </div>
                    ...
                    <?php }?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="serial_no" class="col-sm-4 col-form-label"><?php echo 'Product Code'; ?> </label>
                                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="product_model" class="col-sm-4 col-form-label"><?php echo 'Brand'; ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="product_model" name="model" placeholder="<?php echo 'Brand'; ?>" value="<?php echo $product->product_model?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="salesunit" class="col-sm-4 col-form-label"><?php echo 'Meter Per Box' ?> <i class="text-danger"></i></label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="salesunit" name="salesunit" placeholder="<?php echo 'Meter Per Box'; ?>" value="<?php echo $product->salesunit?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="pcsperboxid" class="col-sm-4 col-form-label"><?php echo 'Pcs Per Box'; ?> <i class="text-danger"></i></label>
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="" class="form-control" id="pcsperboxid" name="pcsperboxid" placeholder="<?php echo 'Pcs Per Box'; ?>" value="<?php echo $product->pcsperboxid?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-hover"  id="product_table">
                                ...
                                <tbody id="proudt_item">
                                    ...
                                    <tr>
                                        ...
                                        <td width="100"> <a  id="add_purchase_item" class="btn edit_btn" name="add-invoice-item" onClick="addpruduct('proudt_item')"  tabindex="9"><i class="fal fa-plus" aria-hidden="true"></i></a>
                                         <a class="btn delete_btn"  value="<?php echo display('delete') ?>" onclick="deleteRow(this)" tabindex="10"><i class="fal fa-trash-alt" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php }else{
                                    ...
                                    ?>
                                        ...
                                        <td width="100"> <a  id="add_purchase_item" class="btn edit_btn" name="add-invoice-item" onClick="addpruduct('proudt_item')"  tabindex="9"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                         <a class="btn delete_btn"  value="<?php echo display('delete') ?>" onclick="deleteRow(this)" tabindex="10"><i class="fal fa-trash-alt" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php }}?>
