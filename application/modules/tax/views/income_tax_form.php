<div class="row">
        ...
        <tr>
            ...
            <td class="paddin5ps"><button type="button" id="delPOIbutton" class="btn delete_btn" value="Delete" onclick="deleteTaxRow(this)"><i class="fal fa-trash-alt"></i></button></td>
            <td class="paddin5ps"><button type="button" id="addmorePOIbutton" class="btn edit_btn" value="Add More POIs" onclick="TaxinsRow()"><i class="fal fa-plus"></button></td>
        </tr>
        </table>
