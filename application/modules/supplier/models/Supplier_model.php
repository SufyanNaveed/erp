...
class Supplier_model extends CI_Model {
   ...
   public function create($data = array())
    ...
    $button .=' <a href="'.$base_url.'edit_supplier/'.$record->supplier_id.'" class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="Update"><i class="fal fa-pencil" aria-hidden="true"></i></a>';

     $button .=' <a onclick="supplierdelete('.$record->supplier_id.')" href="javascript:void(0)"  class="btn delete_btn" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fal fa-trash-alt" aria-hidden="true"></i></a>';
