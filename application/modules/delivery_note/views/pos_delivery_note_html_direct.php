...
<script src="<?php echo base_url() ?>my-assets/js/admin_js/delivery_note_onloadprint.js" type="text/javascript"></script>
                        ...
                        <div class="panel-body">
                            <div bgcolor='#e4e4e4' text='#ff6633' link='#666666' vlink='#666666' alink='#ff6633' >
                                <table border="0" width="40%">
                                    ...
                                    <tr>
                                        <td><strong><?php echo display('delivery_note_no'); ?> : <?php echo $delivery_note_no;?></strong></td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%">
                                    ...
                                    <td align="center"><nobr><?php echo html_escape($delivery_note_data['product_name']).'('.html_escape($delivery_note_data['product_model']).')';?></nobr></td>
                                    <td align="center"><nobr><?php echo html_escape($delivery_note_data['unit']);?></nobr></td>
                                    ...
                                    <tr>
                                        <td align="left"><nobr></nobr></td>
                                    <td align="right" colspan="5"><nobr><?php echo display('delivery_note_discount'); ?></nobr></td>
                                    <td align="right"><nobr>
