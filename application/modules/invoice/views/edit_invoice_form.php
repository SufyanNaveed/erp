                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <td>
                                            ...
                                            <button  class="btn btn-danger text-center" type="button" value="<?php echo display('delete') ?>" onclick="deleteRow_invoice(this)" tabindex="7"><i class="fal fa-trash-alt"></i></button>
                                        </td>
                                    </tr>
                                    <?php }?>
                                </tbody>
 <tfoot>
                    ...
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right cls3" colspan="9">
                                 ...
                                 <tr>
                                    ...
                                    <td class="text-right cls2" colspan="8"><b><?php echo display('change') ?>:</b></td>
                                    <td class="text-right">
