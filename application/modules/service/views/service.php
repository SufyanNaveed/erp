                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="service_list_details" class="table table-striped table-hover ">
                                <thead>
                                    <tr>
                            ...
                            <?php }?>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'edit_service/'.$services['service_id']; ?>" class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fal fa-pencil" aria-hidden="true"></i></a>
                                        
                                    <?php }?>
                                      <?php if($this->permission1->method('manage_service','delete')->access()){ ?>
                                        <a href="<?php echo base_url('service/service/service_delete/'.$services['service_id']) ?>" class="btn delete_btn"  data-toggle="tooltip" data-placement="right" title="delete" onclick="return confirm('Are Your Sure ?')" data-original-title="<?php echo display('delete') ?> "><i class="fal fa-trash-alt" aria-hidden="true"></i></a>
                                    <?php }?>
                                            <?php echo form_close() ?>
                                    </center>
                                    </td>
...
$(document).ready(function() {
    $('#service_list_details').DataTable( {
