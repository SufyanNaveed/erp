...
<div class="printableArea" id="printableArea">
    ...
    <div class="firts_section" style="">
        <div class="first_section_left"  style="width: 45%; display: inline-block;">
           <img src="<?php  echo $currency_details[0]['delivery_note_logo']; ?>" class="img-responsive" alt="">
            <address>
        ...
        <div class="first_section_right"  style="width: 35%; display: inline-block;">
            <h1 style="margin-top:0px;margin-bottom: 0px;"><?php echo display('delivery_note'); ?></h1>
            <address> 
                <abbr><b><?php echo display('delivery_note_no') ?>:</b></abbr> <?php echo html_escape($delivery_note_no) ?><br>
...
<tr>
                    ...
                    <?php
                                                $sl = 1;
                                                $amount = 0;
                                                foreach ($delivery_note_all_data as $item) {
                 ...
                 <div class="row">
                                ...
                                <div class="col-xs-4" style="display: inline-block;">
                                    ...
                                    <table class="table">
                                        <?php
                                        if ($delivery_note_all_data[0]['total_discount'] != 0) {
                                            ?>
                                            <tr>
                                        ...
                                        if ($delivery_note_all_data[0]['total_tax'] != 0) {
                                            ?>
                                            <tr>
                                        ...
                                        <?php } ?>
                                         <?php if ($delivery_note_all_data[0]['shipping_cost'] != 0) {
                                            ?>
                                            <tr>
                                        ...
                                        <?php
                                        if ($delivery_note_all_data[0]['due_amount'] != 0) {
                                            ?>
                                            <tr>
                                 ...
                                 <div class="col-xs-8">
                                    ...
                                    <p></p>
                                    <p><?php echo html_escape($delivery_note_details);?></p> 
