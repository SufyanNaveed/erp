...
class Customer_model extends CI_Model {
   ...
   public function bdtask_paid_customer_dropdown()
  {
    ...
    $button .=' <a href="'.$base_url.'edit_customer/'.$record->customer_id.'" class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="Update"><i class="fal fa-pencil" aria-hidden="true"></i></a>';

     $button .=' <a onclick="customerdelete('.$record->customer_id.')" href="javascript:void(0)"  class="btn delete_btn" data-toggle="tooltip" data-placement="right" title="Delete "><i class="fal fa-trash-alt" aria-hidden="true"></i></a>';
