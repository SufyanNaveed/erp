...
class Invoice extends MX_Controller {
    ...
    public function __construct()
    {
        ...
        $this->load->model(array(
            'invoice_model','customer/customer_model','delivery_note/delivery_note_model')); 
    ...
    function bdtask_invoice_form($delivery_note_id = null) {
        $delivery_note_id =  $this->uri->segment(2);
        ...
        if($delivery_note_id)
        {
            ...
            $data['customer_id']  = $delivery_note_detail[0]['customer_id'];
            $data['customer_name']   = $delivery_note_detail[0]['customer_name'];
            $data['date']            = $delivery_note_detail[0]['date'];
            $data['delivery_note_details'] = $delivery_note_detail[0]['delivery_note_details'];
            $data['delivery_note_all_data']  = $delivery_note_detail;
    ...
    public function bdtask_invoice_details($invoice_id = null){
        ...
        'delivery_note_id'  => $invoice_detail[0]['delivery_note_id'],
    ...
    public function bdtask_delete_invoice($invoice_id = null){
    ...
    public function bdtask_edit_invoice($invoice_id = null){
        ...
        $data = array(
            ...
            'invoicetype'     => $invoice_detail[0]['invoicetype'],
        );
        $data['module']     = "invoice";
