...
var twelveHour = $('.timepicker-12-hr').wickedpicker();
 ...
 "use strict";
   ...
   var total_invoice = $("#total_delivery_note").val();
   var currency = $("#currency").val();
   var deliverynotedatatable = $('#DlvryList').DataTable({ 
             responsive: true,
           ...
           'serverSide': true,
            ...
            },
            {
              ...
              'serverMethod': 'post',
              'ajax': {
              'url': base_url + 'delivery_note/delivery_note/CheckDeliveryNoteList',
              "data": function ( data) {
  ...
  $('#btn-filter').click(function(){ 
    deliverynotedatatable.ajax.reload();  
    });
  ...
  function customer_form(){
   ...
   var base_url  = $('#base_url').val();
    var mydatatable = $('#CustomerList').DataTable({ 
        ...
        language: {
            search: "_INPUT_",
            searchPlaceholder: "Search Customers here"
        },
        buttons: [
            {
                extend:    'copyHtml5',
