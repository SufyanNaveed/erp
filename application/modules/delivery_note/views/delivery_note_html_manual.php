        ...
        <div class="panel-body">
            <div class="row print_header">
                ...
                <div class="col-sm-4 text-left delivery_note-address">
                    ...
                    <div><?php echo display('delivery_note_no') ?>: <?php echo $delivery_note_no?></div>
            ...
            <div class="table-responsive" id="product_infodiv">
               ...
               <div class="row">
                ...
                <div class="col-sm-8 delivery_notefooter-content">

                    <p></p>
                    <p><strong><?php echo $delivery_note_details?></strong></p> 
