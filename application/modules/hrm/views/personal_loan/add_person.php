                   ...
                   <?php echo form_open_multipart('hrm/loan/bdtask_submit_person',array('class' => 'form-vertical','id' => 'inflow_entry' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="reset" class="btn btn-danger" style="border-radius: 8px; height: 35px" value="<?php echo display('reset') ?>" />
                                <input type="submit" id="add-deposit" style="border-radius: 8px; height: 35px" class="btn btn-success" name="add-deposit" value="<?php echo display('save') ?>"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
