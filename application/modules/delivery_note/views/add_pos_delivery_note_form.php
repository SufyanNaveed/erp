...
<?php if($this->permission1->method('manage_delivery_note','read')->access()){ ?>
                    <a href="<?php echo base_url('delivery_note_list') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('manage_delivery_note') ?> </a>
 <?php }?>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span class="text-left"><?php echo display('new_pos_delivery_note') ?></span>
                        </div>
                    </div>
<br>
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart('delivery_note/delivery_note/bdtask_manual_sales_insert', array('class' => 'form-vertical', 'id' => 'pos_sale_insert', 'name' => 'insert_pos_delivery_note')) ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="delivery_note_date" class="col-sm-3 col-form-label"><?php echo display('date') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-6">
                                        <?php
                                       
                                        $date = date('Y-m-d');
                                        ?>
                                        <input class="form-control datepicker" type="text" size="50" id="delivery_note_date" name="delivery_note_date" required value="<?php echo html_escape($date); ?>" tabindex="2" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                 <div class="form-group row">
                                <label for="delivery_note_no" class="col-sm-4 col-form-label"><?php
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" id="adddelivery_note">
                                <thead>
                                    <tr>
                    ...
                    <th class="text-center"><?php echo display('rate') ?> <i class="text-danger">*</i></th>
                                ...
                                <center><label class="text-center" for="details" class="  col-form-label"><?php echo display('delivery_note_details') ?></label></center>
                                <textarea name="inva_details" class="form-control" placeholder="<?php echo display('delivery_note_details') ?>"></textarea>
                                </td>
                                    <td class="text-right" colspan="1"><b><?php echo display('delivery_note_discount') ?>:</b></td>
                                    <td class="text-right">
                                        <input type="text" onkeyup="quantity_calculate(1);"  onchange="quantity_calculate(1);" id="delivery_note_discount" class="form-control text-right total_discount" name="delivery_note_discount" placeholder="0.00"  />
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <input type="text" id="paidAmount" 
                                               onkeyup="delivery_note_paidamount();" class="form-control text-right" name="paid_amount" placeholder="0.00" tabindex="13" value=""/>
                                    </td>
                                </tr>
                                <tr>
                                   
                                   <td align="center">
                                        <input type="button" id="add_delivery_note_item" class="btn btn-info" name="add-delivery_note-item"  onClick="addInputField('adddelivery_noteItem');" value="<?php echo display('add_new_item') ?>" tabindex="12"/>
                                 ...
                                 <tr>
                                    <td align="center">
                                        ...
                                        <input type="submit" id="add_delivery_note" class="btn btn-success" name="add-delivery_note" value="<?php echo display('submit') ?>" tabindex="15"/>
                                    </td>
      ...
      <div class="modal-dialog modal-sm">
        ...
        <a href="" class="close" data-dismiss="modal" aria-hidden="true">&times;</a>
          ...
          <div class="modal-body">
            ...
            <input type="hidden" name="url" value="<?php echo base_url('pos_delivery_note');?>">
          </div>
