                                        ...
                                        foreach ($person_list as $person) {
                                            ...
                                            <tr>
                                                ...
                                                <?php if($this->permission1->method('manage1_person','read')->access()){ ?>
                                                    <a href="<?php echo base_url('edit_office_loan_person/' . $person['person_id']); ?>"class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update">
                                                        <i class="fal fa-pencil" aria-hidden="true"></i>
                                                    </a>
                                                <?php }?>
                                                  <?php if($this->permission1->method('manage1_person','delete')->access()){ ?>
                                                  <a href="<?php echo base_url('hrm/loan/delete_office_loan/'.$person['person_id']) ?>" class="btn delete_btn" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fal fa-trash-alt"></i></a>
                                                  <?php }
                                        ?>
                                                </td>
                                            </tr>
