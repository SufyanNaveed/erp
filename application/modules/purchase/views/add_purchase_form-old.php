                                    ...
                                    <tr>
                                       ...
                                       <td class="wt">
                                            ...
                                            <td>
                                                ...
                                                <button  class="btn delete_btn" type="button" value="<?php echo display('delete')?>" onclick="deleteRow(this)" tabindex="8"><i class="fal fa-trash-alt"></i></button>
                                            </td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td> <button type="button" id="add_invoice_item" class="btn edit_btn" name="add-invoice-item"  onClick="addPurchaseOrderField1('addPurchaseItem')"  tabindex="9"><i class="fal fa-plus"></i></button>
