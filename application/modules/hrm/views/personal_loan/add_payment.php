        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                   ...
                   <?php echo form_open_multipart('hrm/loan/bdtask_submit_personal_payment',array('class' => 'form-vertical','id' => 'inflow_entry' ))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="reset" class="btn btn-danger" style="border-radius: 8px; height: 35px" value="<?php echo display('reset') ?>" tabindex="6"/>
                                <input type="submit" id="add-deposit" style="border-radius: 8px; height: 35px" class="btn btn-success" name="add-deposit" value="<?php echo display('save') ?>" tabindex="7"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
