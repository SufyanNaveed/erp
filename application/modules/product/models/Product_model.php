       ...
       public function getProductList($postData=null){
         ...
         foreach($records as $record ){
          ...
          $jsaction = "return confirm('Are You Sure ?')";
           ...
           $button .= '<a href="'.$base_url.'product/product/bdtask_deleteproduct/'.$record->product_id.'" class="btn delete_btn "  onclick="'.$jsaction.'"><i class="fal fa-trash-alt"></i></a>';
         }

         $button .='  <a href="'.$base_url.'qrcode/'.$record->product_id.'" class="btn payment_btn" data-toggle="tooltip" data-placement="left" title="'.display('qr_code').'"><i class="fal fa-qrcode" aria-hidden="true"></i></a>';

         $button .='  <a href="'.$base_url.'barcode/'.$record->product_id.'" class="btn details_btn" data-toggle="tooltip" data-placement="left" title="'.display('barcode').'"><i class="fal fa-barcode" aria-hidden="true"></i></a>';
      if($this->permission1->method('manage_product','update')->access()){
         $button .=' <a href="'.$base_url.'product_form/'.$record->product_id.'" class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="'. display('update').'"><i class="fal fa-pencil" aria-hidden="true"></i></a>';
     }
