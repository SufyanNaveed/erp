		    ...
		    <div class="col-sm-12">
		        <div class="panel panel-bd lobidrag">
		            ...
		            <div class="panel-body">
						...
						<a href="<?php echo base_url().'supplier_return_details/'.$returns['purchase_id']; ?>" class="btn payment_btn" data-toggle="tooltip" data-placement="left" title="<?php echo display('details') ?>"><i class="fal fa-window-restore" aria-hidden="true"></i></a>
                 <?php if($this->permission1->method('supplier_return_list','delete')->access()){ ?>
							<a href="<?php echo base_url().'return/returns/delete_retutn_purchase/'.$returns['purchase_id']; ?>" class="btn delete_btn" data-toggle="tooltip" data-placement="left" onclick="return confirm('Are you sure??')" title="<?php echo display('delete') ?>"><i class="fal fa-trash-alt" aria-hidden="true"></i></a>
							<?php }?>
