<script src="<?php echo base_url() ?>my-assets/js/admin_js/json/employee.js.php" ></script>
        ...
        <?php if($this->permission1->method('manage_expense','delete')->access()){ ?>
                                                      <a href="<?php echo base_url("hrm/expense/delete_expense/".$expense['voucher_no']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fal fa-trash-alt"></i></a>
                                                    <?php }?>
