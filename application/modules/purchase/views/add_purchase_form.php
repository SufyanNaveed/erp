                    ...
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <?php if ($this->permission1->method('add_supplier', 'create')->access()) { ?>
                                <div class="col-sm-2">
                                    <a class="btn add_btn_add_purch " title="Add New Supplier" href="<?php echo base_url('add_supplier'); ?>"><i class="fal fa-plus"></i></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="number" tabindex="3" class="form-control" name="chalan_no" placeholder="<?php echo display('invoice_no') ?>" id="invoice_no" required />
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody id="addPurchaseItem">
                            <tr>
                                ...
                                <td class="text-right cls1">
                                    <input type="text" name="sales_unit[]" id="sales_unit_1" min="0" class="form-control text-right sales_unit_1" onkeyup="" onchange="" placeholder="0.00" value="" tabindex="6" readonly />
                                ...
                                <td class="text-right">
                                    <input type="text" name="product_quantity[]" id="cartoon_1" required="" min="0" class="form-control text-right store_cal_1" onkeyup="calculate_store(1);" onchange="calculate_store(1);" placeholder="0.00" value="" tabindex="7" />
                                </td>
                                <td class="test">
                                    <input type="text" name="product_rate[]" required="" onkeyup="calculate_store(1);" onchange="calculate_store(1);" id="product_rate_1" class="form-control product_rate_1 text-right" placeholder="0.00" value="" min="0" tabindex="8" />
                                </td>
                                ...
                                <td>
                                    ...
                                    <button class="btn delete_btn" type="button" value="<?php echo display('delete') ?>" onclick="deleteRow(this)" tabindex="9"><i class="fal fa-trash-alt"></i></button>
                                </td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                ...
                                <td> <button type="button" id="add_invoice_item" class="btn edit_btn" name="add-invoice-item" onClick="addPurchaseOrderField1('addPurchaseItem')" tabindex="10"><i class="fal fa-plus"></i></button>
