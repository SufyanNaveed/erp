        ...
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-sm-8" id="payment_from_1">
                        <div class="form-group row">
                            ...
                            <div  class=" col-sm-3">
                               <a href="#" class="client-add-btn btn add_btn btn-primary" aria-hidden="true" data-toggle="modal" data-target="#cust_info"><i class="fal fa-plus "></i></a>
                            </div>
                        <?php } ?>
                        </div>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="normalinvoice">
                        <thead>
                            <tr>
                        ...
                        <td><button type="button" id="add_invoice_item" class="btn edit_btn" name="add-invoice-item"  onClick="addInputField('addinvoiceItem');" ><i class='fal fa-plus'></i></button>
