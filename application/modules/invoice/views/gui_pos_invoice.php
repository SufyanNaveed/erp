...
<table class="table table-stripped table-hover table-sm nowrap gui-products-table" id="addinvoice">
...
<input type="submit" id="add_invoice" class="btn long_purple_button" name="add_invoice" value="Save Sale">
          ...
          <table id="gui_productinfo" class="table table-stripped  table-hover  ">
                                ...
                                <tbody id="gui_tbody">
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url() . 'invoice_details/'.$invoices_list['invoice_id']; ?>" class="btn payment_btn" data-toggle="tooltip" data-placement="left" title="<?php echo display('invoice') ?>"><i class="fal fa-window-restore" aria-hidden="true"></i></a>
                                    <a href="<?php echo base_url() . 'invoice_pad_print/'.$invoices_list['invoice_id']; ?>" class="btn action_btn" data-toggle="tooltip" data-placement="left" title="<?php echo 'Pad Print' ?>"><i class="fal fa-fax" aria-hidden="true"></i></a>

                                        <a href="<?php echo base_url() . 'pos_print/'.$invoices_list['invoice_id']; ?>" class="btn details_btn" data-toggle="tooltip" data-placement="left" title="<?php echo display('pos_invoice') ?>"><i class="fal fa-fax" aria-hidden="true"></i></a>
                                        <?php if($this->permission1->method('manage_invoice','update')->access()){ ?>

                                        <a href="<?php echo base_url() . 'invoice_edit/'.$invoices_list['invoice_id']; ?>" class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="<?php echo display('update') ?>"><i class="fal fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
