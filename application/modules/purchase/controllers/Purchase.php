...
public function bdtask_purchase_details($purchase_id = null){
        ...
        $data = array(
            ...
            'supplier_phone'    => $purchase_detail[0]['contact'],
            'supplier_email'    => $purchase_detail[0]['emailnumber'],
...
public function bdtask_purchase_edit_form($purchase_id = null){
        ...
        $data = array(
            ...
            'invoicetype'   => $purchase_detail[0]['invoicetype'],
     ...
     $bankc = array(
        ...
        for ($i = 0, $n = count($p_id); $i < $n; $i++) {
            ...
            if (!empty($quantity)) {
                ...
                $this->db->update('supplier_product', $sup_data);
            }
        }
