                ...
                <div class="">
                    ...
                    <table width="100%" class="table table-stripped" cellpadding="1" cellspacing="1">
                        ...
                        <tr class="table_data print-footercolor">
                            <td bgcolor="#0073ac">&nbsp;</td>
                            <td align="center" bgcolor="#0073ac">&nbsp;</td>
                            <td align="center" bgcolor="#0073ac">&nbsp;</td>
                            <td align="center" bgcolor="#0073ac">&nbsp;</td>
                            <td  align="right" bgcolor="#0073ac"><strong><?php echo display('total')?></strong></td>
                            <td  align="right" bgcolor="#0073ac"><?php echo html_escape(number_format($TotalDebit,2,'.',',')); ?></td>
                            <td  align="right" bgcolor="#0073ac"><?php echo html_escape(number_format($TotalCredit,2,'.',',')); ?></td>
                            <td  align="right" bgcolor="#0073ac"><?php echo html_escape(number_format((!empty($PreBalance)?$PreBalance:0),2,'.',',')); ?></td>
                        </tr>
