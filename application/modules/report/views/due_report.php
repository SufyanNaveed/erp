                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            ...
                            <span class="padding-lefttitle">       <?php if($this->permission1->method('todays_sales_report','read')->access()){ ?>
                        ...
                        <div id="purchase_div">
                            ...
                            <tr>
                                <td align="left" class="print-table-tr">
                                     <img src="<?php echo base_url().$setting->invoice_logo;?>" alt="logo" width="200" height="200">
                                </td>
                                    ...
                                    <tbody>
                                        ...
                                        <td class="text-right"><?php  if($position == 0){
                                         ...
                                         <td class="text-right"><?php
                                                 if($position == 0){
                                              echo $currency.' '.number_format($sales['paid_amount'],2);  
                                            }else{
