                            ...
                            <table id="dataTableExample3" class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <center>
                                        ...
                                        <a href="<?php echo base_url('personal_loan_edit/'.$persons['person_id']); ?>" class="btn edit_btn" data-toggle="tooltip" data-placement="left" title="" data-original-title="Update"><i class="fal fa-pencil" aria-hidden="true"></i></a>
                                    <?php }?>
                                    <?php if($this->permission1->method('manage_person','delete')->access()){ ?>
                                     <a href="<?php echo base_url("hrm/loan/delete_personal_loan/".$persons['person_id']) ?>" class="btn delete_btn" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="fal fa-trash-alt"></i></a> 
                                     <?php }?>
                                        <?php echo form_close() ?>  
                                    </center>
                                    </td>
