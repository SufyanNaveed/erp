...
<div class="sidebar" style="margin-top: 10px;">
    ...
    <div class="user-panel text-center" style="display: none;">
        <div class="image">
    ...
    <ul class="sidebar-menu">
         ...
         <li class="treeview <?php echo (($this->uri->segment(1)=="home")?"active":null) ?>">
            <a href="<?php echo base_url('home') ?>"> <i class="fal fa-tachometer-alt-slow"></i>  <span><?php echo display('dashboard')?></span> 
            </a>
        </li>
   ...
   <?php if($this->permission1->method('add_quotation','create')->access() || $this->permission1->method('manage_quotation','read')->access()){?>
            ...
            ?>">
                <a href="#">
                    <i class="fal fa-money-check-edit-alt"></i><span><?php echo display('quotation') ?></span>
        ...
        <?php }?>
            <!-- quotation Menu end -->
              <!-- Invoice menu start -->
            <?php if($this->permission1->method('new_invoice','create')->access() || $this->permission1->method('manage_invoice','read')->access() || $this->permission1->method('pos_invoice','create')->access() || $this->permission1->method('gui_pos','create')->access() || $this->permission1->method('new_delivery_note','create')->access() || $this->permission1->method('manage_delivery_note','read')->access() || $this->permission1->method('pos_delivery_note','create')->access()){?>
            <li class="treeview <?php
            if ($this->uri->segment('1') == ("add_invoice") || $this->uri->segment('1') == ("invoice_list") || $this->uri->segment('1') == ("pos_invoice") || $this->uri->segment('1') == ("gui_pos") || $this->uri->segment('1') == ("invoice_details") || $this->uri->segment('1') == ("invoice_pad_print") || $this->uri->segment('1') == ("pos_print") || $this->uri->segment('1') == ("invoice_edit") || $this->uri->segment('1') == ("add_delivery_note") || $this->uri->segment('1') == ("delivery_note_list") || $this->uri->segment('1') == ("pos_delivery_note")  || $this->uri->segment('1') == ("delivery_note_details") || $this->uri->segment('1') == ("delivery_note_pad_print") || $this->uri->segment('1') == ("delivery_note_edit")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                <a href="#">
                    <i class="fal fa-balance-scale"></i><span><?php echo display('invoice') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li  class="treeview <?php
            if ($this->uri->segment('1') == ("add_delivery_note")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('add_delivery_note') ?>"><?php echo display('new_delivery_note') ?></a></li>
                <?php } ?>
                <?php if($this->permission1->method('manage_delivery_note','read')->access()){ ?>
                    <li class="treeview <?php
            if ($this->uri->segment('1') == ("delivery_note_list")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>"><a href="<?php echo base_url('delivery_note_list') ?>"><?php echo display('manage_delivery_note') ?></a></li>
                    <?php } ?>
          ...
          <li class="treeview <?php echo (($this->uri->segment(1)=="add_customer" || $this->uri->segment(1)=="customer_list" || $this->uri->segment(1)=="credit_customer" || $this->uri->segment(1)=="paid_customer" || $this->uri->segment(1)=="edit_customer" || $this->uri->segment(1)=="customer_ledgerdata" || $this->uri->segment(1)=="customer_ledger" || $this->uri->segment(1)=="advance_receipt" || $this->uri->segment(1)=="customer_advance")?"active":'') ?>">
            ...
            <a href="javascript:void(0)">
               ...
               <i class="fal fa-users"></i><span><?php echo display('customer') ?></span>
                 <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
            </a> 
...
<?php if($this->permission1->method('add_supplier','create')->access() || $this->permission1->method('manage_supplier','read')->access() || $this->permission1->method('supplier_ledger','read')->access() || $this->permission1->method('supplier_advance','create')->access()){?>
      <li class="treeview <?php echo (($this->uri->segment(1)=="add_supplier" || $this->uri->segment(1)=="supplier_list" || $this->uri->segment(1)=="edit_supplier" || $this->uri->segment(1)=="supplier_ledgerdata" || $this->uri->segment(1)=="supplier_ledger" || $this->uri->segment(1)=="supplier_advance")?"active":'') ?>">
            ...
            <a href="javascript:void(0)">
               ...
               <i class="fal fa-parachute-box"></i> <span><?php echo display('supplier') ?></span>
                 <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
            </a> 
 ...
 <?php if($this->permission1->method('create_product','create')->access() || $this->permission1->method('add_product_csv','create')->access() || $this->permission1->method('manage_product','read')->access() || $this->permission1->method('create_category','create')->access() || $this->permission1->method('manage_category','read')->access() || $this->permission1->method('add_unit','create')->access() || $this->permission1->method('manage_unit','read')->access()){?>
    <li class="treeview <?php echo (($this->uri->segment(1)=="category_form" || $this->uri->segment(1)=="category_list" || $this->uri->segment(1)=="unit_form" || $this->uri->segment(1)=="unit_list" || $this->uri->segment(1)=="product_form" || $this->uri->segment(1)=="product_list" || $this->uri->segment(1)=="barcode" || $this->uri->segment(1)=="qrcode" || $this->uri->segment(1)=="bulk_products" || $this->uri->segment(1)=="product_details")?"active":'') ?>">
            ...
            <a href="javascript:void(0)">
               ...
               <i class="fal fa-sitemap"></i><span><?php echo display('product') ?></span>
                 <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
            </a> 
...
<?php }?>
      ...
      <!-- Stock menu start -->
        ...
        ?>">
            <a href="#">
                <i class="fal fa-layer-group"></i><span><?php echo display('stock') ?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
    ...
    <?php }?>
        ...
        <?php if($this->permission1->method('show_tree','read')->access() || $this->permission1->method('supplier_payment','create')->access()|| $this->permission1->method('customer_receive','create')->access() || $this->permission1->method('debit_voucher','create')->access() || $this->permission1->method('credit_voucher','create')->access() || $this->permission1->method('aprove_v','read')->access() || $this->permission1->method('contra_voucher','create')->access() || $this->permission1->method('journal_voucher','create')->access()){?>
            <li class="treeview <?php
            if ($this->uri->segment('2') == ("voucher_report") || $this->uri->segment('1') == ("cash_book") || $this->uri->segment('1') == ("bank_book") || $this->uri->segment('1') == ("general_ledger") || $this->uri->segment('1') == ("general_ledger_form") || $this->uri->segment('1') == ("trial_balance") || $this->uri->segment('1') == ("trial_balance_form") || $this->uri->segment('1') == ("profit_loss_form") || $this->uri->segment('1') == ("profit_loss_report") || $this->uri->segment('1') == ("cash_flow")|| $this->uri->segment('1') == ("inventory_ledger")|| $this->uri->segment('1') == ("coa_print") || $this->uri->segment('1') == ("cashflow_form") || $this->uri->segment('1') == ("coa") || $this->uri->segment('1') == ("supplier_payment") || $this->uri->segment('1') == ("supplier_payment_received") || $this->uri->segment('1') == ("customer_payment_receipt") || $this->uri->segment('1') == ("customer_receive") || $this->uri->segment('1') == ("cash_adjustment") || $this->uri->segment('1') == ("debit_voucher") || $this->uri->segment('1') == ("credit_voucher") || $this->uri->segment('1') == ("contra_voucher") || $this->uri->segment('1') == ("journal_voucher") || $this->uri->segment('1') == ("voucher_list") || $this->uri->segment('1') == ("edit_voucher") || $this->uri->segment('1') == ("balance_sheet") || $this->uri->segment('1') == ("opening_balance")) {
                echo "active";
            } else {
                echo " ";
            }
            ?>">
                <a href="#">
                    <i class="fal fa-user-circle"></i><span><?php echo display('accounts') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                ...
                <?php }?>
                 ...
                 <?php if($this->permission1->method('supplier_payment','create')->access()){ ?>
                    <li class="treeview <?php if ($this->uri->segment('1') == ("supplier_payment")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('supplier_payment') ?>"><?php echo display('supplier_payment'); ?></a></li>
                    <?php }?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("debit_voucher")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('debit_voucher') ?>"><?php echo display('debit_voucher') ?></a></li>
                     <?php }?>
                     ...
                     <li class="treeview <?php if ($this->uri->segment('1') == ("credit_voucher")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('credit_voucher') ?>"><?php echo display('credit_voucher'); ?></a></li>
                     <?php }?>
                     ...
                     <?php }?>
                      ...
                      <li class="treeview <?php if ($this->uri->segment('1') == ("voucher_list")){
                        ...
                        echo " ";
                    }?>"><a href="<?php echo base_url('voucher_list') ?>"><?php echo display('voucher_approval'); ?></a></li> 
                     <?php }?>
...
<!--  Account End -->
   ...
   <!-- human resource management menu start -->
            ...
            ?>">
                <a href="#">
                    <i class="fal fa-person-dolly"></i><span><?php echo display('hrm_management') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
    ...
    <!-- ========================== Expense menu end ========================== -->
     ...
     <!-- Bank menu start -->
        ...
        <?php } ?>
            ...
            ?>">
                <a href="#">
                    <i class="fal fa-concierge-bell"></i><span><?php echo display('service') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
        ...
        <?php } ?>
            ...
            ?>">
                <a href="#">
                    <i class="fal fa-money-bill-wave-alt"></i><span><?php echo display('tax') ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
...
<!-- return menu start -->
 <?php if($this->permission1->method('add_return','create')->access() || $this->permission1->method('return_list','read')->access() || $this->permission1->method('supplier_return_list','read')->access() || $this->permission1->method('wastage_return_list','read')->access()){?>
            ...
            ?>">
                <a href="#">
                    <i class="fal fa-exchange"></i><span><?php echo display('return'); ?></span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
...
<!-- return menu end -->
     ...
     <?php if($this->permission1->method('add_role','create')->access() ||$this->permission1->method('role_list','read')->access() || $this->permission1->method('edit_role','create')->access() || $this->permission1->method('assign_role','create')->access()){?>
      ...
      <?php if($this->permission1->method('sms_configure','create')->access()){?>
                <!-- sms menu start -->
                 <li style="display: none;" class="treeview <?php if ($this->uri->segment('1') == ("sms_setting")) { echo "active";}else{ echo " ";}?>">
                <a href="#">
